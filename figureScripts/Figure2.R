...
# saveRDS(integratedData, '/Users/michelgw/integrated_glioma_samples_cohortA.rds')

sampleUMAP <- DimPlot(integratedData, reduction = 'umap', group.by = 'sample') +
    ggtitle('Integrated Samples') +
    scale_color_discrete(labels = c('Glioblastoma A1 ','Oligodendroglioma A1 ','Glioblastoma A2','Glioblastoma A3','Astrocytoma A1',
                                    'Astrocytoma A2','Diffuse Midline Glioma A1','Oligodendroglioma A2',
                                    'Glioblastoma A4','Glioblastoma A5','Oligodendroglioma A3')) +
...
stackedBarPlot <- ggplot(stackedBarData, aes(fill=sample, y=count, x=as.factor(Cluster))) + 
    ...
    scale_fill_discrete(labels = c('Glioblastoma A1 ','Oligodendroglioma A1 ','Glioblastoma A2','Glioblastoma A3','Astrocytoma A1',
                                    'Astrocytoma A2','Diffuse Midline Glioma A1','Oligodendroglioma A2',
                                    'Glioblastoma A4','Glioblastoma A5','Oligodendroglioma A3')) +
...
labels <- c('Glioblastoma A1 ','Oligodendroglioma A1 ','Glioblastoma A2','Glioblastoma A3','Astrocytoma A1',
            'Astrocytoma A2','Diffuse Midline Glioma A1','Oligodendroglioma A2',
            'Glioblastoma A4','Glioblastoma A5','Oligodendroglioma A3')
listOfS <- list()
...
integratedData@meta.data$type <- recode(integratedData@meta.data$sample, 
                                        "FFD1" = 'Glioblastoma A1', 
                                        "FFSlideDB1" = 'Oligodendroglioma A1', 
                                        "FFSlideDC1" = 'Glioblastoma A2', 
                                        "FFSlideDD1" = 'Glioblastoma A3',
                                        "FFSlideEB1" = 'Astrocytoma A1',
                                        "FFSlideEC1" = 'Astrocytoma A2',
                                        "FFSlideED1" = 'Diffuse Midline Glioma A1',
                                        "FFSlideEE1" = 'Oligodendroglioma A2',
                                        "FFSlideGB1" = 'Glioblastoma A4',
                                        "FFSlideGD1" = 'Glioblastoma A5',
                                        "FFSlideGE1" = 'Oligodendroglioma A3')
...
samples <- c("Glioblastoma A1" = "#F8766D", "Oligodendroglioma A1" = "#DE8C00", "Glioblastoma A2" = "#B79F00",
             "Glioblastoma A3" = "#7CAE00","Astrocytoma A1" = "#00BA38", "Astrocytoma A2" = "#00C08B",
             "Diffuse Midline Glioma A1" = "#00B4F0", "Oligodendroglioma A2" = "#619CFF", "Glioblastoma A4" = "#C77CFF",
             "Glioblastoma A5" = "#F564E3", "Oligodendroglioma A3" = "#FF64B0")
